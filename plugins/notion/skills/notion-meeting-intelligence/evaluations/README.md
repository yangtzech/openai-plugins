...
Evaluation scenarios for testing the Meeting Intelligence skill across different model configurations.

## Purpose

These evaluations ensure the Meeting Intelligence skill:
- Gathers context from Notion workspace
- Enriches with supplemental research appropriately
- Creates both internal pre-reads and external agendas
- Distinguishes between Notion facts and supplemental insights
...
- Enriches with supplemental research (decision frameworks, migration best practices)
- Creates comprehensive internal pre-read with recommendation
- Creates clean, professional external agenda
- Clearly distinguishes Notion facts from supplemental insights
...
- Adds supplemental context (industry benchmarks, best practices)
...
3. Verify the skill searches Notion first (not supplemental research)
4. Check that TWO documents are created (internal + external)
5. Verify supplemental enrichment adds value without replacing Notion content
...
### Supplemental Research Integration
...
4. **Verify enrichment value** - Is supplemental research genuinely helpful?
...
- "Supplemental enrichment includes decision frameworks or best practices"
